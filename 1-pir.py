# Demonstrates how to read the passive infra red (PIR) motion detector of
# All-in-one kit for Arduino.
# (C) Kashif Baig
# 
...
try:
    ...
    pir = all_in_one_kit.Digital.IN1
    ...
    while detectEnterKey.is_alive():
        print(f"{datetime.now()} movement detected: {pir.Value}")
        time.sleep(0.05)
finally:
