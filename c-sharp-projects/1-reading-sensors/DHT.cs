...
namespace c_sharp_projects._1_reading_sensors
{
    ...
    {
        /// <summary>
        /// Demonstrates how to enable and read the digital humidity and
        /// temperature (DHT) sensor of All-in-one kit for Arduino.
        ///
        ...
        static void Main(string[] args)
        {
            using (RobotIO all_in_one_kit = new RobotIO(AppConfig.SerialPortName))
            {
                ...
                {
                    Console.WriteLine($"Temp {dht_sensor.Temperature}, Humidity {dht_sensor.Humidity}");
